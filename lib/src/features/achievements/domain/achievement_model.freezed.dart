...
class _$AchievementImpl implements _Achievement {
  ...
  @override
  String toString() {
    return 'Achievement(id: $id, title: $title, description: $description, icon: $icon, requiredCount: $requiredCount, currentCount: $currentCount, isUnlocked: $isUnlocked, unlockedAt: $unlockedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, description, icon,
      requiredCount, currentCount, isUnlocked, unlockedAt);
