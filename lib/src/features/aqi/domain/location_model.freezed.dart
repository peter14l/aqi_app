...
class _$LocationModelImpl implements _LocationModel {
  ...
  @override
  String toString() {
    return 'LocationModel(name: $name, latitude: $latitude, longitude: $longitude, country: $country, admin1: $admin1)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, latitude, longitude, country, admin1);
...
abstract class _LocationModel implements LocationModel {
  const factory _LocationModel(
      ...
      final String? country,
      final String? admin1}) = _$LocationModelImpl;
...
class _$LocationStateImpl implements _LocationState {
  ...
  @override
  String toString() {
    return 'LocationState(name: $name, latitude: $latitude, longitude: $longitude, country: $country)';
  }
...
abstract class _LocationState implements LocationState {
  const factory _LocationState(
      ...
      required final double latitude,
      required final double longitude,
      final String? country}) = _$LocationStateImpl;
